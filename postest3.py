...
city_map = Graph(dict(
    Pitesti=dict(Pitesti=0, Bucharest=110, Craiova=110,
                 Rimnicu=110, Sibiu=110, Fagaras=110),
    Bucharest=dict(Pitesti=110, Bucharest=0, Craiova=110,
                   Rimnicu=110, Sibiu=110, Fagaras=110),
    Craiova=dict(Pitesti=110, Bucharest=110, Craiova=0,
                 Rimnicu=110, Sibiu=110, Fagaras=110),
    Rimnicu=dict(Pitesti=110, Bucharest=110, Craiova=110,
                 Rimnicu=0, Sibiu=110, Fagaras=110),
    Sibiu=dict(Pitesti=110, Bucharest=110, Craiova=110,
               Rimnicu=110, Sibiu=0, Fagaras=110),
    Fagaras=dict(Pitesti=110, Bucharest=110, Craiova=110, Rimnicu=110, Sibiu=110, Fagaras=0)),
    directed=False)
