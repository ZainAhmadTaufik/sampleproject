...
city_map = Graph(dict(
    Kota_A=dict(Kota_B=1900, Kota_C=800, Kota_D=1000),
    Kota_B=dict(Kota_E=1000, Kota_F=1000),
    Kota_F=dict(Kota_T=1000, Kota_G=1500),
    Kota_C=dict(Kota_T=1000, Kota_H=1500),
    Kota_H=dict(Kota_T=1200),
    Kota_D=dict(Kota_I=1800, Kota_T=500)),
    directed=True)
...
class CityProblem(Problem):
    ...
    def path_const(self, cost, A, action, B):
